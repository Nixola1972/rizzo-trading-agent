...
AI_CALL_INTERVAL_MINUTES = int(os.getenv("AI_CALL_INTERVAL_MINUTES", 5))
...
print(f"[main] Avvio trading agent con intervallo di {AI_CALL_INTERVAL_MINUTES} minuti")

while True:
    # Variabili per error handling
    system_prompt = None
    tickers = ['BTC', 'ETH', 'SOL']
    ...
    print(f"[main] Prossima esecuzione tra {AI_CALL_INTERVAL_MINUTES} minuti...")
    time.sleep(AI_CALL_INTERVAL_MINUTES * 60)
