...
class BotoneV6Config:
    ...
    def __init__(self):
        ...
        # DISABLED by default - use TIMEOUT_HOURS instead for smarter exit
        self.time_stop_enabled = os.getenv("TIME_STOP_ENABLED", "false").lower() == "true"
...
class BotoneV6:
    ...
    def _monitor_position(self, position: Position):
        ...
        # === TIME STOP ===
        # Close ALL trades after X minutes - DISABLED by default, use TIMEOUT_HOURS instead
